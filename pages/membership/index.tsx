...
import { returnNumber } from '../../helpers';
import { MembershipContext } from '../../context/membership';
import { membershiAge, membership } from '../../static';

const Membership: NextPage = () => {
  const [toggle, setToggle] = useState(false);
  const { selectedSession, selectedSubscription } = useContext(
    MembershipContext
  );
  ...
  const data = toggle ? membershiAge.plans : membership.plans;
